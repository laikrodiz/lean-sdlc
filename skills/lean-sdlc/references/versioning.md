...
Use when stage, version promise, or exit criteria no longer fit current business reality. Versioning owns these choices; documentation maintenance may only propagate an approved version decision.

Use Sol at `high` because the output is small and the framing is high leverage.
...
Challenge stale `MVP` labels, oversized version promises, and stage language used to avoid decisions.

Success means the project has an honest current context, clear exit criteria, and a small next promise.
