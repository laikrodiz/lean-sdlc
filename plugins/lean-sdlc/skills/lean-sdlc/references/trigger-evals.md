...
| Child visible update | Report current action, why it matters, result or next action; avoid role repetition, end the active turn at completion, keep `followup_task` reuse reachable, and treat silence alone as non-failure. |
