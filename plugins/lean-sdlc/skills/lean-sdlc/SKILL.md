...
4. Apply [Plan](references/plan.md): confirm intent with natural intent confirmation, show a concise visible plan, and define observable completion conditions and proof. A one-item plan is valid.
