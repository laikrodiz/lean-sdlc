...
FROZEN_INVARIANTS = (
    ...
    FrozenInvariant(
        ...
        (
            ...
            "If termination is unconfirmed, stop the transition",
            "It replaces the earlier mode policy for subsequent work",
    ...
    FrozenInvariant(
        "handoff brief and reporting checkpoints",
        SUBAGENTS,
        (
            ...
            "larger or uncertain work",
            "specific decision or risk checkpoint before delegation",
    ...
    FrozenInvariant(
        ...
        (
            ...
            "no ledger edits or git mutations",
   ...
   FrozenInvariant(
    ...
    FrozenInvariant(
        ...
        (
            ...
            "`Routine` means understood, bounded, recoverable, and checkable behavior",
            "`Critical` means consequential data, security, irreversible, shared-contract, concurrency, or subtle architectural risk",
            "cannot use the Quick Fix path",
    ...
    FrozenInvariant(
        ...
        VERIFY,
        (
            "Critical acceptance requires independent verification, including when the Architect writes the implementation",
...
class FrozenInvariantHarnessTests(unittest.TestCase):
    ...
    def test_policy_loading_is_conditional_on_delegation(self) -> None:
        ...
        for phrase in [
            ...
            "Select the requested mode without `--begin`",
            "Read exactly the newly selected workflow above",
            "The helper cannot verify child termination or instruction loading",
